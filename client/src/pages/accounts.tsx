...
import { ArrowLeft, Plus, Landmark, Wallet, Banknote, HelpCircle, Edit2, Check } from "lucide-react";
...
export default function Accounts() {
  ...
  const { accounts, addAccount, updateAccountBalance } = useFinancialStore();
    ...
    <MobileLayout>
      <div className="flex flex-col min-h-full p-6 bg-white dark:bg-black">
        ...
        <Card className="p-6 bg-gray-900 text-white border-none shadow-xl mb-8">
           <p className="text-gray-400 text-sm mb-1">Saldo Total Consolidado</p>
           <h2 className="text-3xl font-bold">R$ {totalBalance.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</h2>
        </Card>
